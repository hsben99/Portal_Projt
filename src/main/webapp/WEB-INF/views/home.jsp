...
<body>
	<form action="" method="get">
			...
			<div id="div3">
				<ul>
					...
					<ul>
						...
						<li><a href="#">[LINC+사업단]2020학년도 LINC+사업단 캡스톤디자인실 또는
						...
						<li><a href="#">[LINC+사업단] 2020년 산학협력 페스티벌 Venture 1st
		...
		<footer>
			<div>
				<ul>
					<li><a href="nbinsertf" class="a1">개인정보처리방침</a></li>
					<li><a href="nbinsert">이메일무단수집거부</a></li>
					<li><a href="nbdetail">오시는길</a></li>
					<li><a href="qbinsertf">교내전화번호</a></li>
					<li><a href="qbinsert">학내백신다운로드</a></li>
					<li><a href="qbdetail">가라링크 사용후삭제</a></li>
					<ul>
